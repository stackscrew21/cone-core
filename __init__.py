...
cone_core = float(_tkinter.TCL_VERSION)
...
class Root(Misc, Wm):
    ...
    def __init__(self, screenName=None, baseName=None, className='Root',
...
def Tcl(screenName=None, baseName=None, className='Tk', useTk=False):
    return Root(screenName, baseName, className, useTk)
...
class Widget(BaseWidget, Start, Place, Grid):
    """Internal class.
...
class Canvases(Widget, XView, YView):
...
class Textarea(Widget, XView, YView):
...
class OptionMenu(MenuButton):
    ...
    def __init__(self, master, variable, value, *values, **kwargs):
        ...
        menu = self.__menu = Menus(self, name="menu", tearoff=0)
...
class Images:
    ...
    def __init__(self, imgtype, name=None, cnf={}, master=None, **kw):
        ...
        if not name:
            Images._last_id += 1
            name = "pyimage%r" % (Images._last_id,) # tk itself would use image<x>
...
class PhotoImages(Images):
    ...
    def __init__(self, name=None, cnf={}, master=None, **kw):
        ...
        width."""
        Images.__init__(self, 'photo', name, cnf, master, **kw)
    ...
    def copy(self):
        ...
        destImage = PhotoImages(master=self.tk)
...
class BitmapImage(Images):
    ...
    def __init__(self, name=None, cnf={}, master=None, **kw):
        ...
        Images.__init__(self, 'bitmap', name, cnf, master, **kw)
